...
ns.BisData = {
    ...
    classes = {
        ...
        SHAMAN = profile("Shaman", "Melee / Healer / Elemental Support", leather, {
            ...
            HANDS=tiers({item(6586,"Scouting Gloves of the Eagle","Healer / elemental suffix"),item(10654,"Jutebraid Gloves","Horde +6 Strength / +6 Intellect quest option; level-29 elite chain gives 2950 XP","HORDE"),item(14572,"Bristlebark Gloves","Melee stats")},{item(12977,"Magefist Gloves","Caster alternative"),item(6586,"Scouting Gloves of the Monkey","Melee survival suffix")},{item(6586,"Scouting Gloves of Healing","Healing-power suffix"),item(6467,"Deviate Scale Gloves","Melee fallback")}),
