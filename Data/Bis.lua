...
ns.BisData = {
    ...
    classes = {
        DRUID = profile("Druid", "Flag Carrier / Midfield / Healer", leather, {
            ...
            FEET = tiers({item(19969,"Nat Pagle's Extreme Anglin' Boots","Flag-carrier stamina"),item(1121,"Feet of the Lynx","Physical mobility")},{item(6335,"Grizzled Boots","Horde stamina quest","HORDE"),item(6668,"Draftsman Boots","Neutral physical quest")},{item(14374,"Sanguine Sandals","Caster stats"),item(9767,"Greenweave Sandals of the Eagle","Caster suffix")}),
            FINGER_1 = tiers(factionChoices(6414,"Seal of Sylvanas",2933,"Seal of Wrynn","quest ring"),{item(4998,"Blood Ring","Flag-carrier stamina"),item(1156,"Lavishly Jeweled Ring","Caster mana")},factionChoices(20429,"Legionnaire's Band",20439,"Protector's Band","WSG physical ring")),
            FINGER_2 = tiers(factionChoices(20426,"Advisor's Ring",20431,"Lorekeeper's Ring","WSG caster ring"),{item(4998,"Blood Ring","Flag-carrier stamina"),item(1156,"Lavishly Jeweled Ring","Caster mana")},factionChoices(20429,"Legionnaire's Band",20439,"Protector's Band","WSG physical ring")),
        ...
        HUNTER = profile("Hunter", "Ranged Pressure / Defense / Midfield", leather, {
            ...
            WRISTS=tiers({item(15331,"Wrangler's Wristbands of the Monkey","Agility / stamina suffix"),item(15331,"Wrangler's Wristbands of the Falcon","Agility / intellect suffix")},{item(3202,"Forest Leather Bracers","Fixed agility"),item(15331,"Wrangler's Wristbands of Stamina","Stamina suffix")},item(15331,"Wrangler's Wristbands of the Eagle","Stamina / intellect suffix")),
        ...
        MAGE = profile("Mage", "Control / Midfield / Burst", caster, {
            ...
            CHEST=tiers(item(1486,"Tree Bark Jacket","Control / survival"),item(6465,"Robe of the Moccasin","Mana / survival alternative"),{item(14127,"Ritual Shroud of Frozen Wrath","Frost-damage suffix"),item(14127,"Ritual Shroud of Fiery Wrath","Fire-damage suffix")}),
            ...
            HANDS=tiers({item(12977,"Magefist Gloves","Balanced caster stats"),item(14162,"Pagan Mitts of Frozen Wrath","Frost-damage suffix")},{item(892,"Gnoll Casting Gloves","General spell-damage alternative"),item(14162,"Pagan Mitts of Fiery Wrath","Fire-damage suffix")},item(14162,"Pagan Mitts of the Eagle","Balanced fallback suffix")),
            WAIST=tiers({item(2911,"Keller's Girdle","Mana / survival"),item(9766,"Greenweave Sash of Frozen Wrath","Frost-damage suffix")},item(9766,"Greenweave Sash of Fiery Wrath","Fire-damage suffix"),item(6539,"Willow Belt of the Eagle","Budget cloth suffix")),
            LEGS=tiers({item(12987,"Darkweave Breeches","Control / survival"),item(6568,"Shimmering Trousers of Frozen Wrath","Frost-damage suffix")},{item(6568,"Shimmering Trousers of Fiery Wrath","Fire-damage suffix"),item(6568,"Shimmering Trousers of the Eagle","Balanced suffix")},noVerified("leg alternative")),
            FEET=tiers(item(19969,"Nat Pagle's Extreme Anglin' Boots","Maximum stamina"),{item(14374,"Sanguine Sandals","Balanced caster stats"),item(9767,"Greenweave Sandals of the Eagle","Balanced suffix")},{item(9767,"Greenweave Sandals of Frozen Wrath","Frost-damage suffix"),item(9767,"Greenweave Sandals of Fiery Wrath","Fire-damage suffix")}),
            FINGER_1=casterRingOne,FINGER_2=casterRingTwo,
            TRINKET_1=trinkets(18850,18859),TRINKET_2=secondTrinkets(18850,18859),
            ONE_HAND=tiers({item(935,"Night Watch Shortsword","Stamina control weapon"),item(3184,"Hook Dagger of Frozen Wrath","Frost-damage suffix")},{item(2567,"Evocator's Blade","Mana alternative"),item(3184,"Hook Dagger of Fiery Wrath","Fire-damage suffix")},item(3184,"Hook Dagger of the Eagle","Balanced suffix fallback")),
            ...
            RANGED=tiers(item(7001,"Gravestone Scepter","Alliance high-damage quest wand","ALLIANCE"),{item(12984,"Skycaller","Neutral BoE wand"),item(5198,"Cookie's Stirring Rod","Neutral dungeon wand")},noVerified("wand alternative")),
        }, {"ONE_HAND","TWO_HAND","OFF_HAND","RANGED"}),
        PALADIN = profile("Paladin", "Support / Defense / Melee", melee, {
            ...
            ONE_HAND=tiers({item(790,"Forester's Axe of the Eagle","Healer random suffix"),item(1482,"Shadowfang","Melee proc weapon")},{item(935,"Night Watch Shortsword","Stamina healer weapon"),item(5191,"Cruel Barb","Melee alternative")},item(1483,"Face Smasher","Melee survival fallback")),
        ...
        PRIEST = profile("Priest", "Healer / Support / Shadow", caster, {
            ...
            NECK=factionNeck(20442,20444),
            SHOULDERS=tiers(item(10657,"Talbar Mantle","Caster stamina / mana"),item(4315,"Reinforced Woolen Shoulders","Crafted armor fallback"),item(4314,"Double-stitched Woolen Shoulders","Budget fallback")),
            ...
            HANDS=tiers({item(12977,"Magefist Gloves","Healer support"),item(892,"Gnoll Casting Gloves","General spell damage")},item(14162,"Pagan Mitts of the Eagle","Balanced support suffix"),item(14162,"Pagan Mitts of Shadow Wrath","Shadow-damage suffix")),
            WAIST=tiers(item(2911,"Keller's Girdle","Healer mana"),{item(9766,"Greenweave Sash of the Eagle","Balanced support suffix"),item(9766,"Greenweave Sash of Stamina","Survival suffix")},{item(14173,"Buccaneer's Cord of the Eagle","Budget caster suffix"),item(14131,"Ritual Belt of Shadow Wrath","Shadow-damage suffix")}),
            LEGS=tiers({item(12987,"Darkweave Breeches","Healer support"),item(10043,"Pious Legwraps","Alliance healing quest","ALLIANCE")},{item(6568,"Shimmering Trousers of the Eagle","Balanced support suffix"),item(6568,"Shimmering Trousers of Shadow Wrath","Shadow-damage suffix")},{item(14125,"Ritual Leggings of the Eagle","Budget support suffix"),item(14125,"Ritual Leggings of Shadow Wrath","Shadow-damage fallback")}),
            ...
            ONE_HAND=tiers({item(2567,"Evocator's Blade","Mana support"),item(15223,"Jagged Star of Healing","Healing random suffix")},{item(3184,"Hook Dagger of the Eagle","Balanced support suffix"),item(3184,"Hook Dagger of Shadow Wrath","Shadow-damage suffix")},noVerified("one-hand alternative")),
            TWO_HAND=tiers({item(2271,"Staff of the Blessed Seer","Healing staff"),item(890,"Twisted Chanter's Staff","Survival / mana staff")},factionChoices(20425,"Advisor's Gnarled Staff",20434,"Lorekeeper's Staff","WSG caster staff"),{item(3415,"Staff of the Friar","Spirit fallback"),item(5201,"Emberstone Staff","Alliance caster quest","ALLIANCE")}),
        ...
        ROGUE = profile("Rogue", "Burst / Flag Return / Defense", leather, {
            NECK=factionNeck(20442,20444),
            SHOULDERS=tiers(item(10657,"Talbar Mantle","Stamina option"),item(15313,"Feral Shoulder Pads","Armor-only alternative"),item(5404,"Serpent's Shoulders","Armor-only fallback")),
            ...
            FEET=tiers({item(1121,"Feet of the Lynx","Burst / flag return"),item(19969,"Nat Pagle's Extreme Anglin' Boots","Stamina / flag return")},{item(10653,"Trailblazer Boots","Horde agility quest","HORDE"),item(6335,"Grizzled Boots","Horde stamina quest","HORDE")},{item(6668,"Draftsman Boots","Neutral physical quest"),item(6582,"Scouting Boots of the Monkey","Budget suffix")}),
            FINGER_1=physicalRingOne,FINGER_2=physicalRingTwo,
            ...
            RANGED=tiers({item(6469,"Venomstrike","Proc / tag pressure"),item(13136,"Lil Timmy's Peashooter","Reliable shot damage")},factionChoices(20437,"Outrider's Bow",20438,"Outrunner's Bow","WSG bow"),{item(3107,"Keen Throwing Knife","Accessible thrown fallback"),item(4372,"Lovingly Crafted Boomstick","Crafted gun fallback")}),
        }, {"ONE_HAND","OFF_HAND","RANGED"}),
        SHAMAN = profile("Shaman", "Midfield / Support / Melee", leather, {
            ...
            BACK=tiers({item(20427,"Battle Healer's Cloak","Horde WSG healer cloak","HORDE"),item(2059,"Sentry Cloak","Melee survival")},{item(6667,"Engineer's Cloak","Hybrid survival"),item(14179,"Watcher's Cape of the Eagle","Elemental suffix")},{item(14179,"Watcher's Cape of Nature's Wrath","Nature-damage suffix"),item(12979,"Firebane Cloak","Situational resistance")}),
            CHEST=tiers({item(1486,"Tree Bark Jacket","Healer / elemental survival"),item(10399,"Blackened Defias Armor","Melee stats")},item(6465,"Robe of the Moccasin","Caster alternative"),{item(14127,"Ritual Shroud of Nature's Wrath","Nature-damage suffix"),item(14562,"Prospector's Chestpiece of the Eagle","Budget hybrid suffix")}),
            WRISTS=tiers({item(15331,"Wrangler's Wristbands of the Eagle","Healer / elemental suffix"),item(15331,"Wrangler's Wristbands of Stamina","Survival suffix")},{item(1974,"Mindthrust Bracers","Mana with stamina penalty"),item(9768,"Greenweave Bracers of Nature's Wrath","Nature-damage suffix")},{item(15331,"Wrangler's Wristbands of the Monkey","Melee suffix"),item(9768,"Greenweave Bracers of the Eagle","Caster fallback")}),
            HANDS=tiers({item(6586,"Scouting Gloves of the Eagle","Healer / elemental suffix"),item(14572,"Bristlebark Gloves","Melee stats")},{item(12977,"Magefist Gloves","Caster alternative"),item(6586,"Scouting Gloves of the Monkey","Melee survival suffix")},{item(14162,"Pagan Mitts of Nature's Wrath","Nature-damage suffix"),item(6467,"Deviate Scale Gloves","Melee fallback")}),
            WAIST=tiers({item(2911,"Keller's Girdle","Caster mana"),item(6468,"Deviate Scale Belt","Melee survival")},{item(9766,"Greenweave Sash of Nature's Wrath","Nature-damage suffix"),item(15329,"Wrangler's Belt of the Eagle","Leather hybrid suffix")},{item(16987,"Screecher Belt","Horde attack power / stamina quest","HORDE"),item(6460,"Cobrahn's Grasp","Melee damage")}),
            LEGS=tiers({item(6587,"Scouting Trousers of the Eagle","Healer / elemental suffix"),item(10410,"Leggings of the Fang","Melee survival")},{item(12987,"Darkweave Breeches","Caster stats"),item(6587,"Scouting Trousers of the Monkey","Melee suffix")},item(6568,"Shimmering Trousers of Nature's Wrath","Nature-damage suffix")),
        ...
        WARLOCK = profile("Warlock", "Survival / Shadow Pressure / Control", caster, {
            ...
            BACK=tiers({item(6667,"Engineer's Cloak","Survival / mana"),item(14179,"Watcher's Cape of Shadow Wrath","Shadow-damage suffix")},item(12979,"Firebane Cloak","Situational fire resistance"),noVerified("cloak alternative")),
            ...
            HANDS=tiers({item(12977,"Magefist Gloves","Survival / mana"),item(892,"Gnoll Casting Gloves","General spell damage")},{item(14162,"Pagan Mitts of Stamina","Survival suffix"),item(14162,"Pagan Mitts of Shadow Wrath","Shadow-damage suffix")},item(14162,"Pagan Mitts of the Eagle","Balanced suffix")),
            WAIST=tiers(item(2911,"Keller's Girdle","Survival / mana"),{item(9766,"Greenweave Sash of Stamina","Survival suffix"),item(9766,"Greenweave Sash of Shadow Wrath","Shadow-damage suffix")},{item(9766,"Greenweave Sash of the Eagle","Balanced suffix"),item(14173,"Buccaneer's Cord of Shadow Wrath","Budget shadow suffix")}),
            LEGS=tiers({item(12987,"Darkweave Breeches","Stamina / mana"),item(10043,"Pious Legwraps","Alliance survival quest","ALLIANCE")},{item(6568,"Shimmering Trousers of Stamina","Survival suffix"),item(6568,"Shimmering Trousers of Shadow Wrath","Shadow-damage suffix")},{item(6568,"Shimmering Trousers of the Eagle","Balanced suffix"),item(14125,"Ritual Leggings of Shadow Wrath","Budget shadow suffix")}),
            ...
            ONE_HAND=tiers({item(935,"Night Watch Shortsword","Stamina weapon"),item(3184,"Hook Dagger of Shadow Wrath","Shadow-damage suffix")},{item(2567,"Evocator's Blade","Mana weapon"),item(3184,"Hook Dagger of Stamina","Survival suffix")},item(3184,"Hook Dagger of the Eagle","Balanced suffix")),
