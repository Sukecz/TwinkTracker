        ...
        ENGINEERING = {
            ...
            steps = {
                ...
                step("SHOPPING LIST 150-225",{
                    line("BRONZE","About 30 Bronze Bars, 15 Medium Leather and 45 Wool Cloth for frameworks and sheep.",{2841,2319,2592}),
                    line("STEEL","4 Steel Bars for one Gyromatic Micro-Adjustor.",{3859,10498}),
                    line("STONE","About 120 Solid Stone for Solid Blasting Powder.",{7912,10505}),
                    line("MITHRIL","About 75-90 Mithril Bars and 20 Mageweave Cloth for tubes, triggers and casings.",{3860,4338}),
                    line("BUFFER","These are planning amounts. Yellow recipes can require extra crafts."),
                }),
                step("SKILL 150-175",{
                    line("150-160","Craft about 15 Bronze Frameworks; keep them.",{4382,2841,2319,2592}),
                    line("160-175","Craft about 15 Explosive Sheep using the saved frameworks, gizmos and Heavy Blasting Powder.",{4384,4382,4375,4377,2592}),
                }),
                step("SKILL 175-200",{
                    line("175-176","Craft one Gyromatic Micro-Adjustor and keep it as an Engineering tool.",{10498,3859}),
                    line("176-195","Craft about 60 Solid Blasting Powder from 120 Solid Stone; keep the powder.",{10505,7912}),
                    line("195-200","Craft about 7 Mithril Tubes from roughly 21 Mithril Bars.",{10559,3860}),
                }),
                step("SKILL 200-225",{
                    line("200-215","Craft about 20 Unstable Triggers using Mithril, Mageweave and saved Solid Blasting Powder.",{10560,3860,4338,10505}),
