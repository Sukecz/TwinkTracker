    ...
    sections = {
        FIRST_AID = {
            ...
            steps = {
                ...
                step("SHOPPING LIST 1-125",{
                    line("LINEN","160-180x Linen Cloth.",{2589}),
                    line("WOOL","100-120x Wool Cloth.",{2592}),
                    line("ALLOWANCE","These planning ranges include extra cloth because yellow and green recipes do not guarantee a skill point."),
                }),
                step("LEVEL 1-125",{
                    line("1-40","Craft about 40x Linen Bandage (40x Linen Cloth).",{1251,2589}),
                    line("40-80","Craft about 40x Heavy Linen Bandage (80x Linen Cloth); train Journeyman at skill 50.",{2581,2589}),
                    line("80-115","Craft about 35x Wool Bandage (35x Wool Cloth).",{3530,2592}),
                    line("115-125","Craft about 10x Heavy Wool Bandage (20x Wool Cloth), then read the Expert book.",{3531,2592}),
                }),
                step("SHOPPING LIST 125-225",{
                    line("WOOL","100-120x Wool Cloth.",{2592}),
                    line("SILK","140-160x Silk Cloth",{4306}),
                    line("MAGEWEAVE","20x Mageweave Cloth",{4338}),
                    line("BOOKS","Buy all 3x BoE book before starting the 125-225 segment.",{16084,16112,16113}),
                    line("ALLOWANCE","These planning ranges include extra cloth because yellow and green recipes do not guarantee a skill point."),
                }),
                step("BOOKS AT SKILL 125",{
                    ...
                    line("ALTERNATIVE","All 3x book are BoE: mail them from a main or buy them from the Auction House.",{16084,16112,16113}),
                }),
                ...
                step("LEVEL 125-225",{
                    line("125-150","Read Under Wraps, then craft about 25x Heavy Wool Bandage (50x Wool Cloth).",{16084,3531,2592}),
                    line("150-180","Train Silk Bandage and craft about 30x (30x Silk Cloth).",{6450,4306}),
                    line("180-210","Read the Heavy Silk manual and craft about 30x Heavy Silk Bandage (60x Silk Cloth).",{16112,6451,4306}),
                    line("210-225","Read the Mageweave manual and craft about 15x Mageweave Bandage (15x Mageweave Cloth).",{16113,8544,4338}),
                ...
                step("COMBAT USE",{
                    ...
                    line("ANTI-VENOM","The rare world-drop manual is usually sourced from the AH; 1x Large Venom Sac creates 3x Strong Anti-Venom.",{6454,1288,6453}),
            ...
            items = {
                ...
                item(1288,"Large Venom Sac","1x sac creates 3x Strong Anti-Venom."),
        ...
        FISHING = {
            ...
            steps = {
                step("SHOPPING LIST TO 150",{
                    ...
                    line("LEVELING LURES","Buy at least 20x Shiny Bauble; carry more if many catches get away.",{6529}),
                    line("EVENT LURES","Stock several Aquadynamic Fish Attractors separately for the Sunday event.",{6533}),
                    line("VARIABLE","Fishing has no fixed material total: only successful catches can grant skill, so lure use depends on catch rate."),
                }),
                step("BUY AND TRAIN",{
                    line("POLE","Buy a Fishing Pole; upgrade to the limited-stock Strong Fishing Pole when available.",{6256,6365}),
                    line("LURES","Buy 20x Shiny Bauble for fewer failed catches while leveling.",{6529}),
                ...
                step("PREPARE FOR SUNDAY",{
                    line("LURE","Stock Aquadynamic Fish Attractors and apply 1x to the pole.",{6533}),
        ...
        ENGINEERING = {
            ...
            steps = {
                ...
                step("SKILL 1-75",{
                    ...
                    line("50-51","Craft 1x Arclight Spanner from 6x Copper Bar and keep it in your bags.",{6219,2840}),
                    line("51-75","Craft about 30x Rough Copper Bomb using 30x Copper Bar, the saved bolts and powder, and 30x Linen Cloth.",{4360,2840,2589}),
                ...
                step("SKILL 75-105",{
                    ...
                    line("90-100","Craft about 20x Coarse Dynamite using 60x saved powder and 20x Linen Cloth.",{4365,4364,2589}),
                ...
                step("SKILL 135-150",{
                    line("135-145","Craft about 30x Heavy Blasting Powder from 30x Heavy Stone.",{4377,2838}),
                    line("145-150","Craft about 15x Whirring Bronze Gizmo from 30x Bronze Bar and 15x Wool Cloth; save them.",{4375,2841,2592}),
            ...
            items = {
                item(2835,"Rough Stone","Buy 60x for the 1-30 Engineering segment."),
                ...
                item(2841,"Bronze Bar","Buy 80x for Bronze Tubes and Whirring Bronze Gizmos."),
                item(2880,"Weak Flux","Buy 25x from an Engineering Supplies vendor for Bronze Tubes."),
                item(1206,"Moss Agate","Buy 10x for Standard Scopes."),
                item(2838,"Heavy Stone","Buy 30x for Heavy Blasting Powder."),
                item(2592,"Wool Cloth","Buy at least 15x for Whirring Bronze Gizmos."),
                ...
                item(6219,"Arclight Spanner","Craft 1x at skill 50 and keep it as an Engineering tool."),
                ...
                item(4377,"Heavy Blasting Powder","Craft about 30x at skill 135-145."),
                item(4375,"Whirring Bronze Gizmo","Craft about 15x at skill 145-150 and save them."),
