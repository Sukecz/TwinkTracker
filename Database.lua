...
function Database:Initialize(saved)
    ...
    if self.data.selectedPage ~= "GEAR" and self.data.selectedPage ~= "BASICS" and self.data.selectedPage ~= "CLASS_TIERS" and self.data.selectedPage ~= "PVP" and self.data.selectedPage ~= "GUIDES" and self.data.selectedPage ~= "EXPLORATION" and self.data.selectedPage ~= "COMMUNITY" then
...
function Database:SetSelectedPage(page)
    if page ~= "GEAR" and page ~= "BASICS" and page ~= "CLASS_TIERS" and page ~= "PVP" and page ~= "GUIDES" and page ~= "EXPLORATION" and page ~= "COMMUNITY" then return false end
