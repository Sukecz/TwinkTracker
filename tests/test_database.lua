...
assert(not ns.Database:SetSelectedBracket(29))
assert(not ns.Database:SetSelectedBracket(39))
assert(ns.Database:Get().selectedBracket == 19)
local unavailableBracket = ns.Database:Initialize({ selectedBracket = 29 })
assert(unavailableBracket.selectedBracket == 19)
ns.Brackets.profiles[29].available = true
local futureBracket = ns.Database:Initialize({ selectedBracket = 29 })
assert(futureBracket.selectedBracket == 29)
ns.Brackets.profiles[29].available = false
ns.Database:Initialize(db)
