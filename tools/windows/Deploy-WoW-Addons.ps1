...
$addons = @(
    ...
    [pscustomobject]@{ DisplayName="TwinkTracker"; ProjectDirectory="twinktracker"; AddonName="TwinkTracker"; PrimaryToc="TwinkTracker.toc"; Directories=@("Locales","Data","assets"); RequiredFiles=@("TwinkTracker.toc","Core.lua","MainWindow.lua","MinimapButton.lua","XPTracker.lua","Locales\enUS.lua","Data\Bis.lua","Data\ClassTiers.lua","Data\PvPEvents.lua","Data\Brackets.lua","Data\BracketRegistry.lua","Data\Bracket29\ClassTiers.lua","Data\Bracket29\Register.lua","assets\logo.png","assets\logo.tga","assets\minimap-icon.tga","assets\bracket-19.tga","assets\bracket-29.tga","assets\bracket-39.tga") }
)
